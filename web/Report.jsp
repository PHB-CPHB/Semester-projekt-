                    ...
                    <table style="width: 100%">
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 20%"><input type="checkbox" name="remark1" value="yes"></td>
                                <td style="width: 20%"><input type="checkbox" name="no-remark1" value="no"> </td>
                                <td style="width: 20%"><input type="checkbox" name="picture1" value="pic"></td>
                            </tr>
                        </table>
                        <table style="width: 100%">
                           <%-- <% if(request.getParameter("remark1").equals("yes")) { %> --%>
                            <input type="text" style="width: 100%; height: 50px; border: 1px solid black; border-top: 1px solid white ">
