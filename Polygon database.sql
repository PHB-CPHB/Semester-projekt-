...
user_firm VARCHAR (10) primary key
);

CREATE TABLE buildings(
building_id INT(25) NOT NULL AUTO_INCREMENT,
...
FOREIGN KEY (building_firm) REFERENCES login(user_firm)
);

INSERT INTO login (username, password, user_id, user_role, user_firm) VALUES ('Oliver', '123', 1, 'admin', 'Polygon');
INSERT INTO login (username, password, user_id, user_role, user_firm) VALUES ('Tim', '1234', 2, 'admin', 'Polygon1');
INSERT INTO login (username, password, user_id, user_role, user_firm) VALUES ('Phillip', '12345', 3, 'customer', 'ABE');
INSERT INTO login (username, password, user_id, user_role, user_firm) VALUES ('Michael', '123456', 4, 'admin', 'Polygon2');
